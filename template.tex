...
\programming{{Docker $\textbullet$ Linux / 5}, {Javascript / 4}, {Python / 5.25}, {PHP $\textbullet$ MySQL / 5.25}}

% Projects text
\projects{
\textbf{Kraken trader} - Tool to get current prices and trade using Kraken API (Python) \\
        \textbf{Money movements} - Tool to classify bank movements based on predefined words per category (Python)\\
        \textbf{Shots on tour} - Just for fun application to select friends and mention you had a drink with them (Ionic/offline tool)\\
